  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{route('jobpost.update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->jobpost_id }}" />
              ...
              <!-- aphone end -->
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Organization Name " name="name" value="{{$data->name}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Location " name="location"  value="{{$data->location}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Basic Salary  " name="salary"  value="{{$data->salary}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Application Instruction" name="app_instruction"  value="{{$data->app_instruction}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="email" class="form-control" id="basic-default-fullname" placeholder="Application Mail" name="app_mail"  value="{{$data->app_mail}}"/>
