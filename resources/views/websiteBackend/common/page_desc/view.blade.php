        ...
        <div class="row">
            ...
            <div class="card text-left">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end m-2 p-2"><a class="p-2" href="{{route('page_desc.all')}}"><button class="btn btn-success">All  information</button></a></div>
                </div>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td class="text-left">{{$data->page_desc_id}}</td>
                      </tr>
                      <tr>
                        <td class="text-end">
                          <strong>Name of the  Page Category</strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
