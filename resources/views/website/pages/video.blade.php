            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 col-xxl-4 mt-4">
                    <div class="hands_video_galllery">
                        <a href=""  data-bs-toggle="modal" data-bs-target="#mymodel{{$data->video_gallery_id}}">
...
@foreach($video as $data)
<div class="modal fade" id="mymodel{{$data->video_gallery_id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
