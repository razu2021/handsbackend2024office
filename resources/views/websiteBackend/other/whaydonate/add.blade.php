    ...
    <div class="row">
      ...
      <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end"><a href="{{route('whaydonate.all')}}">all Infromation</a></small>
          </div>
          <div class="card-body">
            <form method="post" action="{{ route('whaydonate.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Title " name="heading"  value="{{old('heading')}}"/>
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Title " name="subtitle"  value="{{old('subtitle')}}"/>
              ...
              <div class="col-md-12">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname"> Add Description <span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <textarea class="form-control" name="des" id="editor2" value="{{old('des')}}"></textarea>
