  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{url('admin/dashboard/manage-application/category/update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->category_id }}" />
              ...
              <div class="col-md-6">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Set Category as <span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <select name="main_menu_id" id="main_menu_id" class="form-control">
                    <option value="">{{$data->mainMenu->menu_name}}</option>
                    @foreach($all as $alldata)
                    <option value="{{$alldata->menu_id}}">{{$alldata->menu_name}}</option>
                    @endforeach
                </select>
                </div>
              </div>
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the collage/university " name="category_title"  value="{{$data->category_title}}"/>
                </div>
              </div>
              <!-- aphone end -->
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the Depertment " name="category_name"  value="{{$data->category_name}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Session year   " name="category_url" value="{{$data->category_url}}"/>
