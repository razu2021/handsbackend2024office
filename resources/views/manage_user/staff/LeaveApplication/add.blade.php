    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="col-md-6">
              ...
              <input type="date" class="form-control" id="limitedDate" min="<?php echo date('Y-m-01'); ?>" max="<?php echo date('Y-m-10'); ?>" placeholder="Your Current Position  " name="starting_date"  value="{{old('starting_date')}}"/>
