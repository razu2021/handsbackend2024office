      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <!--  -->
            <li class="menu-item ">
              <a href="{{url('/profile_overview')}}" class="menu-link">
              <i class="menu-icon  tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Overview</div>
              </a>
            </li>
            <li class="menu-item ">
              <a href="{{route('all_threads')}}" class="menu-link">
              <i class="menu-icon  tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">All Threads </div>
              </a>
            </li>
            <!--  -->
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon fas fa-solid fa-user"></i>
                <div data-i18n="Account Settings">Profile Manage </div>
              </a>
              <ul class="menu-sub">
                    <li class="menu-item ">
                    <a href="{{url('/dashboard/user/profile')}}" class="menu-link">
                      <div data-i18n="Analytics">Profile Update</div>
                    </a>
                  </li>

                  <li class="menu-item ">
                    <a href="{{url('/dashboard/user/Add_education')}}" class="menu-link">
                      <div data-i18n="Analytics">Add Education</div>
                    </a>
                  </li>
                  <!--  -->
                  <li class="menu-item ">
                    <a href="{{url('dashboard/user/Add_work_places')}}" class="menu-link">
                      <div data-i18n="Analytics">Add work Places</div>
                    </a>
                  </li>
                  <!--  -->
                  <li class="menu-item ">
                    <a href="{{url('/dashboard/user/services')}}" class="menu-link">
                      <div data-i18n="Analytics">Add Service</div>
                    </a>
                  </li>
                  <!--  -->
                  <li class="menu-item ">
                    <a href="{{url('/dashboard/user/portfolio_image')}}" class="menu-link">
                      <div data-i18n="Analytics">Portfolio</div>
                    </a>
                  </li>
                  <!-- end here  -->
                  <li class="menu-item ">
                    <a href="{{url('/dashboard/user/BasicInfo')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              <i class="menu-icon fas fa-solid fa-bars"></i>
                <div data-i18n="Account Settings"> Status </div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('dashboard/user/leave_application')}}" class="menu-link">
                    <div data-i18n="Account">Application</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('work_status.all')}}" class="menu-link">
                    <div data-i18n="Notifications"> work status </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="pages-account-settings-connections.html" class="menu-link">
                    <div data-i18n="Connections"> Sellary Status  </div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="pages-account-settings-notifications.html" class="menu-link">
                    <div data-i18n="Notifications">Live site </div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="pages-account-settings-connections.html" class="menu-link">
          ...
          <!-- main list end here -->
            ...
            <li class="menu-item">
              <a href="{{url('/dashboard/recycle/data')}}" class="menu-link">
              <i class="menu-icon bi bi-trash3-fill"></i>
                <div data-i18n="Analytics">Recycle</div>
              </a>
            </li>
            <!--  -->
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a
                    class="github-button"
                    href="{{asset('contents/assets/website')}}/assets/img/avatar.png"
