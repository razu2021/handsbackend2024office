    ...
    <div class="row">
      ...
      <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end"><a href="{{route('whatsnew.all')}}">All Infromation</a></small>
          </div>
          <div class="card-body">
            <form method="post" action="{{ route('whatsnew.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <!-- item 2 starts  -->
