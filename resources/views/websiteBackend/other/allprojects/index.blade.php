                  ...
                  <div class="card">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <form action="" method="GET">
                              <div class="input-group">
                                ...
                                <div class="input-group-append">
                                  ...
                                  <button class="btn btn-outline-warning" type="submit"><a class="text-dark" href="{{ route('allprojects.all') }}">Reset</a></button>
                                </div>
                              </div>
                              </form>
                          </div>
                      ...
                      <div class="col-lg-3 text-center ">
                          <div class="mb-2 ">
                          <a href="{{ route('allprojects.add') }}"><button class="btn btn-success px-4">Add New Items</button></a>
                  ...
                  <table class="table table-striped" >
                    ...
                    @foreach($all as $data)
                      <tr>
                        ...
                        <td> {!! Str::words($data->pro_des,5) !!}</td>
                        <td>  
                        ...
                        <td> 
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{ route('allprojects.edit',$data->slug)}}">Edit</a></li>
                              <li><a class="dropdown-item" href="{{route('allprojects.view',$data->slug)}}">View</a></li>
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('allprojects.softdelete',$data->allprojects_id)}}">Delete</a></li>
                              <li><hr class="dropdown-divider"></li>
                              @if ($data->post_status == 2) 
                              <li><a class="dropdown-item text-success fw-bold" href="{{route('allprojects.post_active',$data->allprojects_id)}}">Publish</a></li>
                              @elseif($data->post_status == 1)
                              <li><a class="dropdown-item text-warning fw-bold " href="{{route('allprojects.post_deactive',$data->allprojects_id)}}">Unpublished</a></li>
                              @endif
                            </ul>
                          </div>
                        </td>
