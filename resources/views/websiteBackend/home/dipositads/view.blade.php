        ...
        <div class="row">
            ...
            <div class="card text-left">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end m-2 p-2"><a class="p-2" href="{{route('dipositads.all')}}"><button class="btn btn-success">All Banner information</button></a></div>
                </div>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td class="text-end">
                          <strong>Name of the SME Id</strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
                        <td class="text-left">{{$data->dipositads_id}}</td>
                      </tr>
                      <tr>
                        <td class="text-end">
                          <strong>Name of the SME Heading</strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
                      ...
                      <tr>
                        <td class="text-end">
                          <strong>Name of the SME Title </strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
                      ...
                      <tr>
                        <td class="text-end">
                          <strong>Name of the SME Button </strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
                      ...
                      <tr>
                        <td class="text-end">
                          <strong>Name of the SME Image</strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
                        <td class="text-left">
