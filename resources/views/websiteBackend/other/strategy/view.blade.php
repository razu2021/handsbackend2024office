        ...
        <div class="row">
            ...
            <div class="card text-left">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end m-2 p-2"><a class="p-2" href="{{route('strategy.all')}}"><button class="btn btn-success">All Banner information</button></a></div>
                </div>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td class="text-left">{{$data->strategy_id}}</td>
                      </tr>
