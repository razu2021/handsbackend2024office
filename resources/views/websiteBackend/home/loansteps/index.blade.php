                  ...
                  <div class="card">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                      ...
                      <div class="col-lg-3 text-center ">
                          ...
                          <a href="{{route('loansteps.recycle')}}"> <button type="button" class="btn btn-warning position-relative">Recycle<span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger"> {{$deletecount}}+ </span></button></a>
                          </div> 
                      </div>
                    </div>
                    <hr>
