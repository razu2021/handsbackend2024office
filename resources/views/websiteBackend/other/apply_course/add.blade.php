  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('apply_course.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <div class="col-md-12">
              ...
              <div class="col-md-4">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Current Occupation<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Current Occupation " name="occupation"  value="{{old('occupation')}}"/>
              ...
              <div class="col-md-4">
                ...
                <input type="email" class="form-control" id="basic-default-fullname" placeholder="phone !" name="phone"  value="{{old('phone')}}"/>
                <span class="text-danger">@error('phone'){{$message}} @enderror</span>
                </div>
              </div>
              <div class="col-md-4">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">age<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <input type="email" class="form-control" id="basic-default-fullname" placeholder="age !" name="age"  value="{{old('age')}}"/>
              ...
              <div class="col-md-4">
                ...
                <input type="email" class="form-control" id="basic-default-fullname" placeholder="age !" name="gender"  value="{{old('gender')}}"/>
              ...
              <div class="col-md-4">
                ...
                <input type="email" class="form-control" id="basic-default-fullname" placeholder="education !" name="education"  value="{{old('education')}}"/>
              ...
              <div class="col-md-4">
                ...
                <input type="email" class="form-control" id="basic-default-fullname" placeholder="education !" name="address"  value="{{old('address')}}"/>
                <span class="text-danger">@error('address'){{$message}} @enderror</span>
                </div>
              </div>
              <div class="col-md-12">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname"> apply_course Context <span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
