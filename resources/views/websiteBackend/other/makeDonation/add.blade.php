  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('makeDonation.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <div class="col-md-12">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Purpose<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
