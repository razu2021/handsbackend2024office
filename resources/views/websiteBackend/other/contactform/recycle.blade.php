                  ...
                  <div class="card">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <form action="" method="GET">
                              <div class="input-group">
                                ...
                                <div class="input-group-append">
                                  ...
                                  <button class="btn btn-outline-warning" type="submit"><a class="text-dark" href="{{ route('contactform.recycle') }}">Reset</a></button>
                                </div>
                              </div>
                              </form>
                          </div>
                      ...
                      <div class="col-lg-3 text-center ">
                          <div class="mb-2 ">
                          <a href="{{ route('contactform.all') }}"><button class="btn btn-success px-4">All Appoinments</button></a>
                          </div> 
                      </div>
                    </div>
                    <hr>
                        ...
                        <td> 
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('contactform.restore',$data->contactform_id)}}">Restor</a></li>
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('contactform.delete',$data->contactform_id)}}">Delete</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
