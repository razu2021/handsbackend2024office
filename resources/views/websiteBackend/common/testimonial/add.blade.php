          ...
          <div class="card-body">
            <form method="post" action="{{ route('testimonial.submit') }}" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Title " name="name"  value="{{old('name')}}"/>
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your organization Name" name="organization_name"  value="{{old('organization_name')}}"/>
