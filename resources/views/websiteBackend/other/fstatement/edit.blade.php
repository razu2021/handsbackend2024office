  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{route('fstatement.update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->fstatement_id }}" />
              ...
              <div class="col-md-12">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Select Report Type<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <select class="form-control" name="report_type" id="report_type">
                  <option value="{{$data->repor_type}}">{{$data->report_type}}</option>
                  <option value="monthly_report">Monthly Report</option>
                  <option value="half_year_report">Half Year Repor</option>
                  <option value="annual_report">Yearly/Annual  Report</option>
                </select>
              ...
              <div class="col-md-12">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Report<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
