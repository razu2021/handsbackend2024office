        ...
        <div class="row">
            ...
            <div class="card text-left">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end m-2 p-2"><a class="p-2" href="{{route('contactform.all')}}"><button class="btn btn-success">All information</button></a></div>
                </div>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        <td class="text-end">
                          <strong> contactform Id</strong>
                        </td>
                        <td class="text-center"><strong>: </strong></td>
                        <td class="text-left">{{$data->contactform_id}}</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td class="text-center"><strong>: </strong></td>
                        <td class="text-left">{!! $data->answer !!}
                        </td>
                      </tr>
                      <tr>
                        <!-- caption end  -->
