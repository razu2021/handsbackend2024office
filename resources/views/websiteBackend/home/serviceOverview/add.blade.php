    ...
    <div class="row">
      ...
      <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end"><button class="btn btn-outline-success" type="submit"><a class="text-dark" href="{{ route('serviceOverview.all') }}">all Infromation </a></button></small>
          </div>
          <div class="card-body">
            <form method="post" action="{{ route('serviceOverview.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <!-- item 2 starts  -->
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write top Heading Name " name="top_heading"  value="{{old('top_heading')}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Banner. !optional " name="button"  value="{{old('button')}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder=" Button " name="button_url"  value="{{old('button_url')}}"/>
