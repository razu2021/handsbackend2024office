      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{url('admin/dashboard/manage-application/socialmedia/update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->social_media_id }}" />
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Social Media Name " name="social_media_name"  value="{{$data->social_media_name}}"/>
                </div>
              </div>
              <!-- aphone end -->
              </div>
