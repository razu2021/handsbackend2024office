  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{ route('field_storise.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <!-- item 2 starts  -->
              <div class="col-md-12">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Add Embed Link <span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Add Embed Link" name="service_image"  value="{{old('service_image')}}"/>
              ...
              <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write Heading Name " name="location"  value="{{old('location')}}"/>
