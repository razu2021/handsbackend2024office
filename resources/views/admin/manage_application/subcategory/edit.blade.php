  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{url('admin/dashboard/manage-application/subcategory/update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->subcategory_id }}" />
              ...
              <div class="col-md-6">
                <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">Set subcategory as <span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                <select name="category_menu_id" id="category_menu_id" class="form-control">
                    <option value="">{{$data->categoryMenu->category_name}}</option>
                    @foreach($all as $alldata)
                    <option value="{{$alldata->category_id}}">{{$alldata->category_name}}</option>
                    @endforeach
                </select>
                </div>
              </div>
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the collage/university " name="subcategory_title"  value="{{$data->subcategory_title}}"/>
                </div>
              </div>
              <!-- aphone end -->
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the Depertment " name="subcategory_name"  value="{{$data->subcategory_name}}"/>
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Session year   " name="subcategory_url" value="{{$data->subcategory_url}}"/>
