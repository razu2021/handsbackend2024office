                            ...
                            <form action="" method="GET">
                              <div class="input-group">
                                ...
                                <div class="input-group-append">
                                  ...
                                  <button class="btn btn-outline-warning" type="submit"><a class="text-dark" href="{{ route('video_gallery.all') }}">Reset</a></button>
                                </div>
                              </div>
                              </form>
                          </div>
                        ...
                        <td> 
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{ route('video_gallery.edit',$data->slug)}}">Edit</a></li>
                              <li><a class="dropdown-item" href="{{route('video_gallery.view',$data->slug)}}">View</a></li>
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('video_gallery.softdelete',$data->video_gallery_id)}}">Delete</a></li>
                              <li><hr class="dropdown-divider"></li>
                              @if ($data->post_status == 2) 
                              <li><a class="dropdown-item text-success fw-bold" href="{{route('video_gallery.post_active',$data->video_gallery_id)}}">Publish</a></li>
                              @elseif($data->post_status == 1)
                              <li><a class="dropdown-item text-warning fw-bold " href="{{route('video_gallery.post_deactive',$data->video_gallery_id)}}">Unpublished</a></li>
                              @endif
                            </ul>
                          </div>
                        </td>
