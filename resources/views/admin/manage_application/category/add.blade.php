  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="post" action="{{url('admin/dashboard/manage-application/category/submit')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        <!-- aphone end -->
                        <div class="col-md-6">
                          ...
                          <select name="main_menu_id" id="main_menu_id" class="form-control">
                            <option value=""> Category Set as</option>
                          @foreach($all as $data)
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Add Title<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Item Name  " name="category_title"  value="{{old('category_title')}}"/>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Item Name  " name="category_name"  value="{{old('category_name')}}"/>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Set-URL-for-this-Item" name="category_url"  value="{{old('category_url')}}"/>
                          <span class="text-danger">@error('category_url'){{$message}} @enderror</span>
                          </div>
                        </div>
                        <!-- aphone end -->
                        </div>
