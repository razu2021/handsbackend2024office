                            ...
                            <form action="" method="GET">
                              <div class="input-group">
                                ...
                                <div class="input-group-append">
                                  ...
                                  <button class="btn btn-outline-warning" type="submit"><a class="text-dark" href="{{ route('smeads.all') }}">Reset</a></button>
                                </div>
                              </div>
                              </form>
                          </div>
                        ...
                        <td> 
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" href="{{ route('smeads.edit',$data->slug)}}">Edit</a></li>
                              <li><a class="dropdown-item" href="{{route('smeads.view',$data->slug)}}">View</a></li>
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('smeads.softdelete',$data->smeads_id)}}">Delete</a></li>
                              <li><hr class="dropdown-divider"></li>
                              @if ($data->post_status == 2) 
                              <li><a class="dropdown-item text-success fw-bold" href="{{route('smeads.post_active',$data->smeads_id)}}">Publish</a></li>
                              @elseif($data->post_status == 1)
                              <li><a class="dropdown-item text-warning fw-bold " href="{{route('smeads.post_deactive',$data->smeads_id)}}">Unpublished</a></li>
                              @endif
                            </ul>
                          </div>
                        </td>
