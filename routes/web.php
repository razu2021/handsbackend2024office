...
/*-----about section----*/
Route::get('/about-human-and-nature-developmetn-society-(hands)', [WebsiteController::class, 'about_us']);
...
Route::get('/our-stratiegy', [WebsiteController::class, 'our_stratiegy']);
Route::get('/our-mission-and-our-vision', [WebsiteController::class, 'mission_vision']);
Route::get('/our-faith', [WebsiteController::class, 'our_faith']);
/*-----what we do section----*/
Route::get('/what-we-do', [WebsiteController::class, 'what_we_do']);
Route::get('/micro-finance-loan', [WebsiteController::class, 'micro_finance'])->name('sme-loans');
Route::get('/basic-loan', [WebsiteController::class, 'basic_loan']);
Route::get('/microenterprice-loan', [WebsiteController::class, 'microenterpris_loan']);
Route::get('/crop-loan', [WebsiteController::class, 'crop_loan']);
Route::get('/livestock-loan', [WebsiteController::class, 'livestock_loan']);
Route::get('/special-loan', [WebsiteController::class, 'special_loan']);
Route::get('/house-loan', [WebsiteController::class, 'house_loan']);
Route::get('/agriculture-loan', [WebsiteController::class, 'agriculture_loan']);
Route::get('/higher-education-loan', [WebsiteController::class, 'higher_education']);
Route::get('/woman-empowerment-loan', [WebsiteController::class, 'woman_empowerment']);
/*-----seving account section----*/
Route::get('/hands-saving-accounts-plan', [WebsiteController::class, 'saving_ac_plan'])->name('sevings');
Route::get('/hands-pension-scheme', [WebsiteController::class, 'hands_pension_scheme']);
Route::get('/fixed-dipsit-plan', [WebsiteController::class, 'fixed_diposit']);
Route::get('/dubble-and-8years-diposit', [WebsiteController::class, 'diposit_limit']);
Route::get('/family-welfair-saving-plan', [WebsiteController::class, 'family_saving']);
Route::get('/two-years-saving', [WebsiteController::class, 'two_years_saving']);
/*-----what we do dropdown section----*/
Route::get('/emergency relief for emergency crisis', [WebsiteController::class, 'emergency_relif']);
Route::get('/what-we-do-for-economic-development-for-underprivileged-area', [WebsiteController::class, 'economic_development']);
Route::get('/what-we-do-for-child-protection', [WebsiteController::class, 'child_protection']);
Route::get('/support-for-education', [WebsiteController::class, 'education_program']);
Route::get('/health-and-nutrition', [WebsiteController::class, 'health_nutrition']);
Route::get('/water-sanitation-and-hygiene', [WebsiteController::class, 'water_hygiene']);
/*-----legal aid section----*/
Route::get('legal-aid', [WebsiteController::class, 'legal_aid']);
Route::get('legal-aid-awareness-and-training', [WebsiteController::class, 'awareness']);
Route::get('mediation', [WebsiteController::class, 'mediation']);
Route::get('public-interest-litigation', [WebsiteController::class, 'pil']);
Route::get('litigation', [WebsiteController::class, 'litigation']);
/*-----gallery section----*/
Route::get('our-gallery', [WebsiteController::class, 'gallery']);
Route::get('video-gallery', [WebsiteController::class, 'video_gallery']);
Route::get('photo-gallery', [WebsiteController::class, 'photo_gallery']);
...
Route::get('our-impact', [WebsiteController::class, 'our_impact']);
/*-----team section ----*/
Route::get('our-team', [WebsiteController::class, 'our_Team']);
Route::get('our-genrel-team', [WebsiteController::class, 'genrel_team']);
...
Route::get('get-support', [WebsiteController::class, 'support']);
Route::get('hands-notice-board', [WebsiteController::class, 'notice']);
