    ...
    <div class="row">
      ...
      <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0 fw-bold">Add your Education  </h5>
                      <small class="text-muted float-end">Add your work Collage/University Information</small>
                    </div>
                    <div class="card-body">
                      <form method="post" action="{{url('dashboard/user/Add_education/submit')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        <!-- aphone end -->
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the collage/university " name="collage_name"  value="{{old('collage_name')}}"/>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the Depertment " name="subject_name"  value="{{old('subject_name')}}"/>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Session year   " name="session_date"  value="{{old('session_date')}}"/>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Name of the Depertment " name="degree_name"  value="{{old('degree_name')}}"/>
