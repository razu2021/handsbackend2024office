    ...
    <div class="row">
      ...
      <div class="card mb-4">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <small class="text-muted float-end"><a href="{{route('bannerbottom.all')}}">All Information </a> </small>
          </div>
          <div class="card-body">
            <form method="post" action="{{ route('bannerbottom.submit') }}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <!-- aphone end -->
              <!-- item 2 starts  -->
              <div class="col-md-12">
                ...
                <select class="form-control" name="category_as" id="category_as">
                  <option value="">banner Set as </option>
