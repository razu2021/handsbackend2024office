...
<html   lang="{{ str_replace('_', '-', app()->getLocale()) }}"
  ...
  <title>Md Razu Hossain Raj || Human and Nature Development Society (HANDS)</title>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item " >
              <a href="{{url('admin/dashboard/manage_application/recycle')}}" class="menu-link" style="background:#fff2ed">
                <i class="menu-icon tf-icons bx bx-recycle"></i>
                <div data-i18n="Analytics">Recycle Bin</div>
              </a>
            </li>
            ...
            <li class="menu-item">
              ...
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('admin/dashboard/admin_allusers')}}" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Account Settings">All Banner </div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{url('admin/dashboard/website-manage/home-banner')}}" class="menu-link">
                ...
                <li class="menu-item">
                  <a href="{{url('admin/dashboard/website-manage/blade-page')}}" class="menu-link">
            ...
            <footer class="content-footer footer  bg-white mt-4">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  , made with ❤️ by
                  <a href="https://themeselection.com" target="_blank" class="footer-link fw-bolder">Md Razu Hossain Raj</a>
                </div>
                <div>
