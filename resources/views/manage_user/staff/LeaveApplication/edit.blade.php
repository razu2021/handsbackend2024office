...
<section>
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="body_con">
          <form action="{{url('dashboard/user/leave_application/update')}}" method="post">
            @csrf
          ...
          <!-- form to end  -->
          <div class="ror">
          <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $alldata->application_id }}" />
          ...
          <div class="col-md-6">
              ...
              <input type="text" class="form-control" id="basic-default-fullname" placeholder="Sub: Application for leave   " name="app_subject"  value="{{$alldata->app_subject}}" />
          ...
          <div class="app_declaretion">
              ...
              <textarea name="app_diclaration" id="" class="form-control" rows="4" placeholder="write your application diclaretion here........" value="{{$alldata->app_diclaration}}">{{$alldata->app_diclaration}}</textarea>
        ...
        <div class="col-md-6">
              ...
              <input type="date" class="form-control" id="limitedDate" min="<?php echo date('Y-m-01'); ?>" max="<?php echo date('Y-m-10'); ?>" placeholder="Your Current Position  " name="starting_date"  value="{{$alldata->starting_date}}"/>
              ...
              <div class="mb-3">
              <label class="form-label" for="basic-default-fullname"> Starting Date  <span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
              <input type="date" class="form-control" id="limitedDate" min="<?php echo date('Y-m-01'); ?>" max="<?php echo date('Y-m-10'); ?>" placeholder="Your Current Position  " name="ending_date"  value="{{$alldata->ending_date}}"/>
          ...
          <!-- end col  -->
              ...
              <option value="{{$alldata->leave_details}}">{{$alldata->leave_details}}</option>
          ...
          <div class="col-md-6">
              ...
              <option value="{{$alldata->leave_reason}} "> {{$alldata->leave_reason}} </option>
          ...
          <!-- end col  -->
              ...
              <input type="text" class="form-control" id="basic-default-fullname" placeholder="Additional Comments/Explanation (if needed)" name="additional_comment" value="{{$alldata->additional_comment}}"/>
