  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{route('slogan.update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->slogan_id }}" />
              ...
              <div class="col-md-12">
                ...
                <select class="form-control" name="set_as" id="set_as">
                  <option value="{{$data->set_as}}">{{$data->set_as}} </option>
                  <option value="donation_slogan">Make for Donation</option>
                  <option value="organization_slogan">Make for Organization</option>
                  <option value="other_slogan">Make for Other</option>
                </select>
