            ...
            <div class="col-12 col-lg-12">
                 <!-- Basic Bootstrap Table -->
                  <div class="card">
                    <div class="row">
                      <div class="col-lg-8 offset-lg-2">
                        <div class=" text-center pt-4 pb-0">
                          <h2 style="border-bottom: 5px solid red; display:inline-block;background:#011a41;padding:3px;border-radius:10px;color:white;text-transform:uppercase"> 
                            All Socialmedia URL Information 
                          </h2>
                        </div>
                      </div>
                            ...
                            <form action="" method="GET">
                              <div class="input-group">
                                ...
                                <div class="input-group-append">
                                  ...
                                  <button class="btn btn-outline-warning" type="submit"><a class="text-dark" href="{{url('admin/dashboard/manage-application/socialmediaurl')}}">Reset</a></button>
                                </div>
                              </div>
                              </form>
                          </div>
                      ...
                      <div class="col-lg-3  d-flex justify-content-end">
                          <div class=" mb-2 ">
                          <a href="{{url('admin/dashboard/manage-application/socialmediaurl/add')}}"><button class="btn btn-success px-4">Add New Items</button></a>
                          </div>
                      </div>
                    </div>
                    <hr>
                  <table class="table table-striped" >
                    ...
                    <tbody>
                    @foreach($socialmediaurl as $data)
                      <tr>
                        <td> {{$data->url_id}}</td>
                  ...
                  <div class="container">
                      <div class="row pt-4 ">
                        <div class="col-lg-8"><tr><td><p>Showing 1 to {{$socialmediaurl->count()}} of {{$totalpost }} Entair</p></td></tr></div>
                        <div class="col-lg-4 d-flex justify-content-end">
                          <div class="row">{{ $socialmediaurl->links() }}</div>
                        </div>
                      </div>
                  </div>
                  </div>
