  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="post" action="{{url('dashboard/user/Add_work_places/update')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        ...
                        <div class="mb-3">
                          ...
                          <textarea type="text" class="form-control" id="basic-default-fullname" placeholder="about you " name="job_des"  value="{{$data->job_des}}"> {{$data->job_des}}</textarea>
