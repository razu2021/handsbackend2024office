        ...
        <div class="row">
            ...
            <div class="card text-left">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end m-2 p-2"><a class="p-2" href="{{route('field_storise.all')}}"><button class="btn btn-success">All  information</button></a></div>
                </div>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td class="text-left">{{$data->field_storise_id}}</td>
                      </tr>
                      <tr>
                        <td class="text-end">
                      ...
                      <tr>
                        ...
                        <td class="text-left">
                          ...
                          <iframe width="100%" height="350px" src="{{$data->service_image}}" title="{{$data->title}}" frameborder="0" allow="accelerometer; autoplay;" allowfullscreen></iframe>
                          @else
