        ...
        <div class="row">
            ...
            <div class="card text-left">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-end m-2 p-2"><a class="p-2" href="{{route('photo_gallery.all')}}"><button class="btn btn-success">All  information</button></a></div>
                </div>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      <tr>
                        ...
                        <td class="text-left">{{$data->photo_gallery_id}}</td>
                      </tr>
                      <tr>
                        <td class="text-end">
                      ...
                      <tr>
                        ...
                        <td class="text-left">
                          ...
                          <img src="{{asset('uploads/website/gallery/'.$data->service_image)}}" alt="banner Image " width="auto" height="200px" style="border-radius:10%">
                          @else
