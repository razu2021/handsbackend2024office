  ...
  <div class="container">
    <div class="row">
      ...
      <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="post" action="{{url('admin/dashboard/manage-application/subcategory/submit')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        <!-- aphone end -->
                        <div class="col-md-6">
                          ...
                          <select name="category_menu_id" id="category_menu_id" class="form-control">
                            <option value=""> subcategory Set as</option>
                          @foreach($all as $data)
                        ...
                        <div class="col-md-6">
                          <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Add Title<span class="text-danger"> <i class="fas fa-solid fa-star"></i></span></label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Item Name  " name="subcategory_title"  value="{{old('subcategory_title')}}"/>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Item Name  " name="subcategory_name"  value="{{old('subcategory_name')}}"/>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Set-URL-for-this-Item" name="subcategory_url"  value="{{old('subcategory_url')}}"/>
                          <span class="text-danger">@error('subcategory_url'){{$message}} @enderror</span>
                          </div>
                        </div>
                        <!-- aphone end -->
                        </div>
