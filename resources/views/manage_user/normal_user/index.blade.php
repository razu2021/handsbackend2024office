@extends('alluser.user.user-dashboard')
@section('users_contents')
                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                          What Is the <strong>Relationship</strong> with Human and Nature Development Society <b>(HANDS)</b>. If any Relationship with HANDS please Update your Role Type and Access your <strong>Dashboard </strong> Now !
                          </p>
                            @if(Auth::user()->role !== Auth::user()->role_request)
                            @if(Auth::user()->role_request == 0)
                            <h3 class="card-title text-danger">Request_Normal User </h3>
                            @elseif(Auth::user()->role_request == 1)
                            <h3 class="card-title text-danger"> Request_Employee </h3>
                            @elseif(Auth::user()->role_request == 2)
                            <h3 class="card-title text-danger"> Request_Customer </h3>
                            @elseif(Auth::user()->role_request == 3)
                            <h3 class="card-title text-danger">Request_Volunteer </h3>
                            @endif
                            <button class="btn btn-outline-warning text-danger">Role Request has been Pandign !</button>
                            @else
                            <button class="btn btn-outline-success text-dark">Normal User Dashboard</button>
                            @endif
                        </div>
                      </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Your User Role : </span>
                          @if(Auth::user()->role == 0)
                  ...
                  <div class="card">
                    <div class="row row-bordered g-0">
                      <div class="col-md-4">
                        ...
                        <button class="btn btn-outline-success"><a target="_blank" class="text-dark" href="https://handsbd.org/">Visit Website</a></button>
                        </div>
                      </div>
