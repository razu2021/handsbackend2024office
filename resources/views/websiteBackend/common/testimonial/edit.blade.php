      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
            <form method="post" action="{{route('testimonial.update')}}" enctype="multipart/form-data">
              @csrf
              <div class="row">
              <input type="hidden" class="form-control" id="basic-default-fullname" name="id"  value="{{ $data->testimonial_id }}" />
              ...
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Write your Title " name="organization_name" value="{{$data->organization_name}}"/>
