                  ...
                  <div class="card">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                      ...
                      <div class="col-lg-3 text-center ">
                          <div class="mb-2 ">
                          <a href="{{ route('aboutus.all') }}"><button class="btn btn-success px-4">All Appoinments</button></a>
                          </div> 
                      </div>
                    </div>
                    <hr>
                        ...
                        <td> 
                          <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('aboutus.restore',$data->aboutus_id)}}">Restor</a></li>
                              <li><a class="dropdown-item" onclick="return confirm('Delete this Information')" href="{{route('aboutus.delete',$data->aboutus_id)}}">Delete</a></li>
                            </ul>
                          </div>
                        </td>
                      </tr>
